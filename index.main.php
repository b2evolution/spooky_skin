...
<div class="bPosts">
	...
	<?php
		...
		<div id="<?php $Item->anchor_id() ?>" class="bPost bPost<?php $Item->status_raw() ?>" lang="<?php $Item->lang() ?>">
		 <div class="bPostHeader"></div>
		  <div class="bPostTextWrapper">
...
<div id="pageFooter">
	...
	<p class="baseline">
		...
		<?php display_param_link( $skin_links ) ?> design by <a href="http://www.iguts.de">Tears</a>
